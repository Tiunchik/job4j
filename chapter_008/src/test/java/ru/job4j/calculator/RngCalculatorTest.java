...
/**
 * Класс RngCalculatorTest - contains tests for inner methods for Calculator and Interpritator.
 *
...
public class RngCalculatorTest {
    ...
    public void testInterpritator17plus4() {
        ...
        assertEquals("17", tempMas[0]);
        assertEquals("+", tempMas[1]);
    ...
    public void testRngCalculatorCos0() {
        ...
        String[] tempMas = new Interpritator().understand(tempText);
        tempMas[0] = "0"; //lastresult emulation
